...
| SPEC-023 | Picker Stock Limit (= 武器 5 / 強化 5) + Reroll (= 1戦 2回) | Implementing | Phase 0 / Phase 1 | #29 (open、 旧 #27 は close) |
| SPEC-024 | Picker Card Category Label + Lv.1 Effect Audit (= Oriflamme +0 → +1) | Implementing | Phase 0 / Phase 1 | feat/spec-024-picker-cat-and-lv1-fix |
